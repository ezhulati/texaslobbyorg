  ...
  if (success) {
    return (
      <div className="rounded-lg border border-green-200 bg-green-50 p-8 text-center">
        ...
        <h3 className="text-2xl font-bold text-green-900 mb-2">Profile Submitted!</h3>
        <p className="text-green-700 mb-4">
          Your profile has been submitted for review. We'll email you within 24-48 hours once it's approved.
        </p>
