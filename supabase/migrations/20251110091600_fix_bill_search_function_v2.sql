-- Fix bill search function to prioritize bill number matches (v2 with correct column names)
...
BEGIN
  ...
  SELECT
    ...
    b.last_action,
    b.last_action_date,
    b.fiscal_note_url as full_text_url,
    b.view_count,
    CASE
...
COMMENT ON FUNCTION search_bills IS 'Search bills with prioritized ranking: exact bill number match (100) > starts with (50) > contains (25) > full-text search (0-10)';
